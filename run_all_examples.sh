...
if [ $status -eq 0 ]; then
  ...
  for f in $(find $CMakeDir -maxdepth 3 -type f '(' -name 'colour' -o -name 'colour.exe' -o -name 'colour_for' -o -name 'colour_for.exe' -o -name 'version' -o -name 'version.exe' ')' -exec test -x {} \; -print)
  do
